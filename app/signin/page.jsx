            ...
            <div className="w-full p-6 m-auto bg-white rounded-md shadow-md lg:max-w-xl">
                ...
                <form onSubmit={(e)=>handleSignUp(e)} className="space-y-4">
                    <div>
                        ...
                        <input onChange={handleInputChange} type="text" placeholder="Name" className="w-full input input-bordered input-primary" />
                    </div>
                    <div>
                        <label className="label">
                            <span className="text-base label-text">Email</span>
                        </label>
                        <input onChange={handleInputChange} type="text" placeholder="Email Address" className="w-full input input-bordered input-primary" />
                    </div>
                    <div>
                        <label className="label">
                            <span className="text-base label-text">Password</span>
                        </label>
                        <input onChange={handleInputChange} type="password" placeholder="Enter Password"
                    ...
                    <div>
                        ...
                        <input onChange={handleInputChange} type="password" placeholder="Confirm Password"
                            className="w-full input input-bordered input-primary" />
                    </div>
                    <div>
